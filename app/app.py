...
def predict():
    prediction = None
    input_data = {feature: "" for feature in INPUT_FEATURES}  # Khởi tạo input trống mặc định
    ...
    return render_template("index.html", features=INPUT_FEATURES, prediction=prediction, input_data=input_data)
